...
public:
	...
	void initialize(UAS &uas_) override
	{
		...
		qgc_to_ros_pub = gp_nh.advertise<mavros_msgs::KrisoStatus>("kriso/data", 5);
	...
	{
		return {
				make_handler(&QgcToRosPlugin::handle_qgc_data)
...
PLUGINLIB_EXPORT_CLASS(mavros::std_plugins::QgcToRosPlugin, mavros::plugin::PluginBase)
